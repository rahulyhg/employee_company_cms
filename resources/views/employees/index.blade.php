            ...
            <table class="table table-condensed">
                ...
                <tbody>
                    @foreach($employees as $key => $employee)
                        @php    auth()->user()->can_manage_employee($employee) ? $color = "bg_green": $color = ""  @endphp
                    <tr>
                        <td class="text-center">{{ $employees->firstItem() + $key }}</td>
                        <td class="{{$color}}">{{ $employee->first_name }} {{ $employee->last_name }}</td>
                        <td class="{{$color}}">{{ $employee->company->name }}</td>
                        <td class="{{$color}}">{{ $employee->email }}</td>
                        <td class="{{$color}}">{{ $employee->phone }}</td>
