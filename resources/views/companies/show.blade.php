  ...
  <div class="col-xs-12">
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <h3 class="panel-title" style="margin: 6px 0px;">Manage Managers</h3>
            <a href="/managerpermission/create/{{$company->id}}"><button class="btn btn-primary" type="button" name="button">Add Manager</button></a>
        ...
        <table class="table table-condensed">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $manager->email }}</td>
                    <td>
                      <form class="" action="/managerpermission/delete" method="post">
                        {{ csrf_field() }}
                        {{ method_field('DELETE') }}
                        <input type="hidden" name="manager" value="{{$manager->id}}">
                        <input type="hidden" name="company" value="{{$company->id}}">
                        <button type="submit" class="btn btn-danger" name="button">Remove Access</button>
                      </form>
