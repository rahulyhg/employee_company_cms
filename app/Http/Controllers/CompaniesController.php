...
class CompaniesController extends Controller
{
    ...
    public function store(CompanyCreateRequest $request)
    {
      ...
      if ($user->role == "manager") {
        return redirect()->back()->withErrors(['Managers cannot create companies.']);
      }
    ...
    public function show(Company $company)
    {
      ...
      $managers  = $company->managers()->get();
        ...
        return view('companies.show', compact('company', 'employees', "managers"));
    }
    ...
    public function edit(Company $company)
    {
      ...
      $user = auth()->user();
      $has_permission = ManagerPermission::where('user_id', $user)->where("company_id", $company->id)->first();
      if ($user->role == "manager" && !$has_permission) {
        return redirect()->back()->withErrors(['You need permission to edit this company']);
      }
    ...
    public function destroy(Company $company)
    {
      $user = auth()->user();
      if ($user->role == "manager") {
        return redirect()->back()->withErrors(['Managers cannot delete a company.']);
      }
